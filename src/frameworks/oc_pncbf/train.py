...
def _record_eval(
    ...
    # v2.7.6 STANDING (04_eval s3b extension): 3-D systems also emit the yz section + band_zero_offset scalar.
    if getattr(system, "name", None) == "quadrotor_3d":
        try:
            ...
            yz = plot_quadrotor3d_yz_contour(system, value_net, config, scenes_yz,
                run_dir / "figures/inloop" / f"step_{step:06d}_cbf_contour_yz.png", role="OC in-loop yz", source=_src)
